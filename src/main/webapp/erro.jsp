...
<main class="container my-5 custom-bg text-dark">
    <div class="d-flex align-items-center justify-content-center min-vh-90">
        <div class="text-center mt-5">
            <h1 class="display-1 fw-bold" style="color: #1F2A44">Ops!</h1>
            <p class="fs-2 fw-medium mt-4" style="color: #1F2A44">Algo deu errado</p>
            <p class="mt-4">Tivemos um problema inesperado. Tente novamente em instantes.</p>
