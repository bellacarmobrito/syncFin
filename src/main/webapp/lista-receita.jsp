...
<html>
<head>
    <title>Lista de Receitas - SyncFin</title>
    ...
    <div class="mt-5 ms-5 me-5">
        ...
        <div class="card mb-3 shadow-sm">
            <div class="card-header text-black bg-white border-0">
                <h5 class="card-header bg-white border-0 fw-bold" style="color: #1F2A44">Lista de Receitas</h5>
            </div>
            <div class="card-body">
                    ...
                    <c:otherwise>
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="text-start">Descricao</th>
                                <th class="text-start">Valor</th>
                                <th class="text-start">Data de Recebimento</th>
                            ...
                            <c:forEach items="${receitas}" var="receita">
                                <tr>
                                    <td class="text-start">${receita.categoria}</td>
                                    ...
                                    <td class="text-start">${receita.status}</td>
                                    <td class="text-center">
                                        <c:url var="linkEditar" value="receita">
                        ...
                        <a href="cadastro-receita.jsp" class="btn btn-primary">Adicionar receita</a>
                    </c:otherwise>
                </c:choose>
