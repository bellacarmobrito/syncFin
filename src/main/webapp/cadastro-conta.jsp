    ...
    <div class="form-wrapper">
        <div class="card mb-3 shadow-sm">
            <div class="card-header text-black bg-white border-0">
                <h5 class="card-header bg-white border-0 fw-bold" style="color: #1F2A44">Cadastre sua conta
                    bancária</h5>
            ...
            <div class="card-body">
                <form action="conta-bancaria" method="post">
                    ...
                    <div class="mb-3">
                        <label for="tipoConta" class="form-label"><strong>Tipo de Conta</strong></label><br>
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        <input type="submit" value="Cadastrar" class="btn btn-primary w-auto"></div>
                </form>
            </div>
        </div>
    </div>
